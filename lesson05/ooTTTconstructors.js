...
function Square(marker) {
  this.marker = marker || Square.UNSUED_SQUARE;
}

Square.UNSUED_SQUARE = ' ';
Square.HUMAN_MARKER = 'X';
Square.COMPUTE_MARKER = 'O';
...
Square.prototype.isUnused = function () {
  return this.marker === Square.UNSUED_SQUARE;
}
...
function Computer() {
  Player.call(this, Square.COMPUTE_MARKER)
}
...
TTTGame.prototype.displayGoodbyeMessage = function() {
  console.log("Thanks for palying Tic Tac Toe! Goodbye!");
}
